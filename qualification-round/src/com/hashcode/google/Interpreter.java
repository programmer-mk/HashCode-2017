...
public class Interpreter {
	...
	public Interpreter(String filePath) {
		...
		int currentLine = 1;
		 for(int endPointID = 0; endPointID < numberOfEndpoints; endPointID++){
	            ...
	            for(int connectedCacheServerNumber = 0; connectedCacheServerNumber < numberOfConnectedCacheServers; connectedCacheServerNumber++){
	            	currentLine++;
	            	line = lines[currentLine].split(" ");
	     ...
	     for(int requestID = 0; requestID <numberOfRequests; requestID++){
	         ...
	         Request request = new Request(requestID,videoID,endPointID, Integer.parseInt(line[2]));
	...
	public void calculateValue(Video video) {
	...
	public int getBestAvailableLatency(Request request){
